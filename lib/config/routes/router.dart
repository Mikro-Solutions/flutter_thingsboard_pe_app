...
import 'package:systemat_app/core/auth/auth_routes.dart';
import 'package:systemat_app/core/auth/noauth/routes/noauth_routes.dart';
import 'package:systemat_app/core/context/tb_context.dart';
import 'package:systemat_app/core/init/init_routes.dart';
import 'package:systemat_app/modules/alarm/alarm_routes.dart';
import 'package:systemat_app/modules/asset/asset_routes.dart';
import 'package:systemat_app/modules/audit_log/audit_logs_routes.dart';
import 'package:systemat_app/modules/customer/customer_routes.dart';
import 'package:systemat_app/modules/dashboard/dashboard_routes.dart';
import 'package:systemat_app/modules/device/device_routes.dart';
import 'package:systemat_app/modules/home/home_routes.dart';
import 'package:systemat_app/modules/main/main_routes.dart';
import 'package:systemat_app/modules/more/more_routes.dart';
import 'package:systemat_app/modules/notification/routes/notification_routes.dart';
import 'package:systemat_app/modules/profile/profile_routes.dart';
import 'package:systemat_app/modules/tenant/tenant_routes.dart';
import 'package:systemat_app/modules/url/url_routes.dart';
import 'package:systemat_app/modules/version/route/version_route.dart';
import 'package:systemat_app/utils/ui_utils_routes.dart';
